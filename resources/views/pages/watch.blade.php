	...
	<section class="section details">
		...
		<div class="container">
			<div class="row">
							...
							<div class="col-12 col-sm-8 col-md-8 col-lg-9 col-xl-9">
								<div class="card__content">
									...
									<ul class="card__meta">
										...
										<li><span>thời lượng phim:</span>{{$movie_slug->thoiLuong.''}} </li>
										@if($movie_slug->category->title!='movie')
				...
				<div class="col-12 col-xl-6 iframe_film">
						{{!! $episode_select->link !!}}
				</div>
				<!-- end player -->
							...
							<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
								<div class="card-body">
									<table class="accordion__list">
										...
										<tbody>
											@foreach($movie_slug->episode as $key => $tap)
											<tr>

												<th>
													<a href="{{url('xem-phim/'.$movie_slug->slug.'/tap-'.$tap->episode)}}">tập {{$tap->episode}}
												</a></th>
